...
public class TestCaseTest {
  ...
  public void getFlatRepresentationQueryHeaderBodyTest() {
    ...
    assertEquals(
        "The flat representation of the test case is wrong",
        "POST/booksapplication/jsonq1val1q2val2h1valF1h2valF2example body",
        tc1.getFlatRepresentation());
    assertEquals(
        "The flat representation of the test case is wrong",
        "POST/booksapplication/jsonq1val1q2val2h1valF1h2valF2example body",
        tc2.getFlatRepresentation());
    assertEquals(
        "The two test cases should have the same flat representation",
        tc1.getFlatRepresentation(),
        tc2.getFlatRepresentation());
  }
  ...
  public void getFlatRepresentationPathFormTest() {
    TestCase tc1 =
        new TestCase("abc", true, "updatePage", "/books/{bookId}/{page}", PathItem.HttpMethod.PUT);
    tc1.setFaultyReason("inter_parameter_dependency");
    ...
    TestCase tc2 =
        new TestCase("def", false, "updatePage", "/books/{bookId}/{page}", PathItem.HttpMethod.PUT);
    tc2.setFaultyReason("none");
    ...
    assertEquals(
        "The flat representation of the test case is wrong",
        "PUT/books/valF1/valF2application/x-www-form-urlencodedq1val1q2val2",
        tc1.getFlatRepresentation());
    assertEquals(
        "The flat representation of the test case is wrong",
        "PUT/books/valF1/valF2application/x-www-form-urlencodedq1val1q2val2",

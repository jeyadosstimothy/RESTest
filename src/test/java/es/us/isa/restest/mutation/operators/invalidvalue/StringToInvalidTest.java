...
public class StringToInvalidTest {
  ...
  public void mutationAppliedTest() {
    ...
    TestCase tc =
        new TestCase("dfgsdfg", true, "getComment", "/comments/{id}", PathItem.HttpMethod.GET);
    ...
    assertEquals(
        ...
        "Violated 'max_length' constraint of string parameter id",
        StringToInvalid.mutate(tc, paramToMutate));
    assertTrue(
        "The string value should be longer than 4 characters",
        tc.getParameterValue(paramToMutate).length() > 4);

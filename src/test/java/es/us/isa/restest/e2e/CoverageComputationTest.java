...
public class CoverageComputationTest {
  ...
  public void wrongThirdArgumentTest() {
    try {
      String[] args = {
        "src/test/resources/restest-test-resources/coverage-data/swagger.yaml",
        "src/test/resources/restest-test-resources/coverage-data",
        "noInteger"
      };
      CoverageComputation.main(args);
      fail("This test should throw an exception.");
  ...
  public void dirPathDoesntExistTest() {
    try {
      String[] args = {
        "src/test/resources/restest-test-resources/coverage-data/swagger.yaml", "noPath"
      };
      CoverageComputation.main(args);
      fail("This test should throw an exception.");
    } catch (IllegalArgumentException e) {
  ...
  public void validTest() {
    ...
    String aPrioriCoveragePath =
        "src/test/resources/restest-test-resources/coverage-data/test-coverage-priori.csv";
    String aPosterioriCoveragePath =
        "src/test/resources/restest-test-resources/coverage-data/test-coverage-posteriori.csv";

...
public class FuzzingTestCaseGeneratorTest {
  ...
  public void commentsFuzzingTestCaseGenerator() throws RESTestException {
    ...
    TestConfigurationObject conf =
        TestConfigurationIO.loadConfiguration(
            "src/test/resources/Comments/testConf_forTestSuite3.yaml", spec);
  ...
  public void travelFuzzingTestCaseGenerator() throws RESTestException {
    ...
    TestConfigurationObject conf =
        TestConfigurationIO.loadConfiguration(
            "src/test/resources/Travel/testConf_betty_test.yaml", spec);
  ...
  public void comments2FuzzingTestCaseGenerator() throws RESTestException {
    ...
    TestConfigurationObject conf =
        TestConfigurationIO.loadConfiguration(
            "src/test/resources/Comments/testConf_forTestSuite6.yaml", spec);
    ...
    Collection<TestCase> testCasesCommentsMultiplePath =
        testCases.stream()
            .filter(tc -> tc.getPath().equals("/comments/multiple"))
            .collect(Collectors.toList());

    assertEquals(5, testCasesCommentsMultiplePath.size());

    testCasesCommentsMultiplePath.forEach(
        tc -> {
          assertTrue(
              "The generated body should be an array of objects",
  ...
  public void scoutApiFuzzingTestCaseGenerator() throws RESTestException {
    ...
    TestConfigurationObject conf =
        TestConfigurationIO.loadConfiguration(
            "src/test/resources/restest-test-resources/testConf-scout.yaml", spec);

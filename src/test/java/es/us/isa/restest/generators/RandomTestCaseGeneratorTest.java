...
public class RandomTestCaseGeneratorTest {
  ...
  public void memesTestCaseGeneratorWithInvalidGeneratorWithFaults() throws RESTestException {
    ...
    // Assert that the invalid generator was used everytime, since no mutation could be applied to
    // make the test case invalid
  ...
  public void commentsFullTestCaseGeneratorWithFaults() throws RESTestException {
    ...
    assertEquals(
        ...
        expectedNumberOfInvalidTestCases,
        testCases.stream()
            .filter(c -> c.getFaulty() == null || c.getFaulty())
            .count()); // One of the 4 operations cannot be mutated.
    assertTrue(
        "Incorrect number of faulty test cases (according to the OAS validator)",
        expectedNumberOfInvalidTestCases
            >= GeneratorTestHelper.numberOfInvalidTestCases(testCases, spec));
  ...
  public void scoutApiTestCaseGenerator() throws RESTestException {
    ...
    assertEquals(
        ...
        expectedNumberOfValidTestCases,
        testCases.stream().filter(c -> !c.getFaulty()).count());
    //		assertEquals("Incorrect number of valid test cases (according to the OAS validator)",
    // expectedNumberOfValidTestCases, GeneratorTestHelper.numberOfValidTestCases(testCases, spec));
    ...
    assertEquals(
        ...
        expectedNumberOfInvalidTestCases,
        testCases.stream().filter(c -> c.getFaulty()).count());
    //		assertEquals("Incorrect number of faulty test cases (according to the OAS validator)",
    // expectedNumberOfInvalidTestCases, GeneratorTestHelper.numberOfInvalidTestCases(testCases,
    // spec));

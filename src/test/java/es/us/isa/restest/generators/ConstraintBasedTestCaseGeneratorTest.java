...
public class ConstraintBasedTestCaseGeneratorTest {
  ...
  public void bikewiseFullTestCaseGeneratorNoConstraints() throws RESTestException {
    ...
    AbstractTestCaseGenerator generator =
        new ConstraintBasedTestCaseGenerator(spec, conf, numTestCases);
    ...
    // Valid test cases
    assertEquals(
        "Incorrect number of valid test cases generated (according to the generator counter)",
        expectedNumberOfTestCases,
        generator.getnNominal());
    assertEquals(
        "Incorrect number of valid test cases (according to the attribute faulty)",
        expectedNumberOfTestCases,
        testCases.stream().filter(c -> !c.getFaulty()).count());
    assertEquals(
        "Incorrect number of valid test cases (according to the OAS validator)",
        expectedNumberOfTestCases,
        GeneratorTestHelper.numberOfValidTestCases(testCases, spec));

    // Write RESTAssured test cases
    String basePath = spec.getSpecification().getServers().get(0).getUrl();
    RESTAssuredWriter writer =
        new RESTAssuredWriter(
            OAISpecPath,
            testConf,
            "src/generation/java/restassured",
            "BikewiseTest",
            "restassured",
  ...
  public void bikewiseFullTestCaseGeneratorNoConstraintsWithFaults() throws RESTestException {
    ...
    TestConfigurationObject conf =
        TestConfigurationIO.loadConfiguration("src/test/resources/Bikewise/fullConf.yaml", spec);
    ...
    int expectedNumberOfValidTestCases =
        expectedNumberOfTestCases - expectedNumberOfInvalidTestCases;
    ...
    assertEquals(
        "Incorrect number of valid test cases generated (according to the generator counter)",
        expectedNumberOfValidTestCases,
        generator.getnNominal());
    assertEquals(
        "Incorrect number of valid test cases (according to the attribute faulty)",
        expectedNumberOfValidTestCases,
    ...
    // Invalid test cases
    assertEquals(
        "Incorrect number of faulty test cases generated (according to the generator counter)",
        expectedNumberOfInvalidTestCases,
        generator.getnFaulty());
    assertEquals(
        "Incorrect number of faulty test cases (according to the attribute 'faulty')",
        expectedNumberOfInvalidTestCases,
        testCases.stream().filter(c -> c.getFaulty()).count());
    assertEquals(
        "Incorrect number of faulty test cases (according to the OAS validator)",
        expectedNumberOfInvalidTestCases,
        GeneratorTestHelper.numberOfInvalidTestCases(testCases, spec));
  }
  ...
  public void memesTestCaseGeneratorWithInvalidGeneratorWithoutFaults() throws RESTestException {
    ...
    // Load configuration
    TestConfigurationObject conf =
        TestConfigurationIO.loadConfiguration(
            "src/test/resources/Memes/testConf_forTestSuite.yaml", spec);
  ...
  @Test
  public void memesTestCaseGeneratorWithInvalidGeneratorWithFaultsParameters()
    ...
    for (TestCase tc : testCases)
      if (tc.getPath().equals("/gallery/{id}"))
        assertEquals(
            "Incorrect parameter value", "invalid_value", tc.getPathParameters().get("id"));
  }

  @Test
  public void memesTestCaseGeneratorWithInvalidGeneratorWithFaultsDependencies()
      throws RESTestException {
    // Load specification
    String OAISpecPath = "src/test/resources/Memes/swagger_forTestSuite.yaml";
    OpenAPISpecification spec = new OpenAPISpecification(OAISpecPath);
    ...
    assertEquals(
        "Incorrect number of valid test cases (according to the OAS validator)",
        expectedNumberOfTestCases,
        GeneratorTestHelper.numberOfValidTestCases(testCases, spec)); // According to OAS, all valid
  ...
  @Test
  public void memesTestCaseGeneratorWithInvalidGeneratorWithSomeFaultsParametersDependencies()
      throws RESTestException {
    // Load specification
    String OAISpecPath = "src/test/resources/Memes/swagger_forTestSuite.yaml";
    OpenAPISpecification spec = new OpenAPISpecification(OAISpecPath);
    ...
    assertEquals(
        "Incorrect number of valid test cases (according to the OAS validator)",
        8,
        GeneratorTestHelper.numberOfValidTestCases(
            testCases, spec)); // 2 valid, 4 with invalid data gen, and 2 violating deps
  ...
  public void spotifyGetArtistWithFilterAndFaults() throws RESTestException {
    ...
    // Load configuration
    TestConfigurationObject conf =
        TestConfigurationIO.loadConfiguration("src/test/resources/Spotify/defaultConf.json", spec);
  ...
  public void amadeusHotelFullTestCaseGeneratorWithFaults() throws RESTestException {
    ...
    int expectedNumberOfInvalidTestCases = (int) (faultyRatio * expectedNumberOfTestCases);
    int expectedNumberOfInvalidTestCasesDueToDependencies =
        (int) (faultyRatio * faultyDependencyRatio * expectedNumberOfTestCases);
    int expectedNumberOfValidTestCases =
        expectedNumberOfTestCases - expectedNumberOfInvalidTestCases;
    int expectedNumberOfValidTestCasesAccordingToValidator =
        expectedNumberOfTestCases
            - (expectedNumberOfInvalidTestCases
                - expectedNumberOfInvalidTestCasesDueToDependencies);
    ...
    assertEquals(
        "Incorrect number of valid test cases (according to the OAS validator)",
        expectedNumberOfValidTestCasesAccordingToValidator,
        GeneratorTestHelper.numberOfValidTestCases(testCases, spec));
    ...
    assertEquals(
        "Incorrect number of faulty test cases (according to the OAS validator)",
        expectedNumberOfInvalidTestCases - expectedNumberOfInvalidTestCasesDueToDependencies,
        GeneratorTestHelper.numberOfInvalidTestCases(testCases, spec));
  ...
  public void commentsConstraintBasedTestCaseGeneratorWithFaults() throws RESTestException {
    ...
    assertEquals(
        "Incorrect number of valid test cases (according to the attribute faulty)",
        expectedNumberOfValidTestCases,
        testCases.stream().filter(c -> c.getFaulty() != null && !c.getFaulty()).count());
    assertTrue(
        "Incorrect number of valid test cases (according to the OAS validator)",
        expectedNumberOfValidTestCases
            <= GeneratorTestHelper.numberOfValidTestCases(testCases, spec));
  ...
  @Test
  public void commentsConstraintBasedTestCaseGeneratorWithFiltersAndFaults()
      throws RESTestException {
    ...
    int expectedNumberOfInvalidTestCasesDueToDependencies =
        (int) (expectedNumberOfTestCases * faultyDependencyRatio * faultyDependencyRatio);
    int expectedNumberOfInvalidTestCasesDueToIndividualConstraints =
        expectedNumberOfInvalidTestCases - expectedNumberOfInvalidTestCasesDueToDependencies;
    int expectedNumberOfValidTestCases =
        expectedNumberOfTestCases - expectedNumberOfInvalidTestCases;
    ...
    assertEquals(
        ...
        GeneratorTestHelper.numberOfInvalidTestCases(testCases, spec));
    assertEquals(
        "Incorrect number of faulty test cases generated due to dependency violations",
        expectedNumberOfInvalidTestCasesDueToDependencies,
        generator.getnFaultyTestDueToDependencyViolations());
    assertEquals(
        "Incorrect number of faulty test cases generated due to individual constraints",
        expectedNumberOfInvalidTestCasesDueToIndividualConstraints,
        generator.getnFaultyTestsDueToIndividualConstraint());

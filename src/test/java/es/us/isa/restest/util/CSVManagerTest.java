...
public class CSVManagerTest {
  ...
  public void testCreateCSV() {
    ...
    assertFalse(
        ...
        readCSV("src/test/resources/csvData/csvManagerSample.csv").isEmpty());
  }
  ...
  public void testReadCSVWithHeader() {
    ...
    csv = readCSV(path);
    assertEquals(
        "The second value of the first row should be 'field2", "field2", csv.get(0).get(1));
    assertEquals(
        "The third value of the second row should be 'value3", "value3", csv.get(1).get(2));
  }
  ...
  public void testReadCSVWithoutHeader() {
    ...
    assertEquals(
        "The second value of the first row should be 'value2", "value2", csv.get(0).get(1));
    assertEquals(
        "The third value of the second row should be 'value6", "value6", csv.get(1).get(2));
  }

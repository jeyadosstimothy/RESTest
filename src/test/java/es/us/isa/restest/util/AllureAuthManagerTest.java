...
public class AllureAuthManagerTest {
  ...
  public void shouldFindAuthProperties() {
    List<String> properties =
        findAuthProperties(
            testOas, "src/test/resources/restest-test-resources/configuration-model.yaml");
  ...
  public void shouldApplyConfidentialityFilter() throws IOException {
    confidentialityFilter(
        Collections.singletonList("Authorization"), "src/test/resources/htmlData");

    MatcherAssert.assertThat(
        Objects.requireNonNull(FileManager.readFile("src/test/resources/htmlData/htmlSample.html")),
        containsString("CENSORED"));
    MatcherAssert.assertThat(
        Objects.requireNonNull(
            FileManager.readFile("src/test/resources/htmlData/htmlSample1.html")),
        containsString("CENSORED"));
  }

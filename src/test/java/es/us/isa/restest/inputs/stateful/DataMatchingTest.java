...
public class DataMatchingTest {
  ...
  public static void setUp() {
    ...
    try {
      dict =
          (ObjectNode)
              objectMapper.readTree(new File("src/test/resources/jsonData/data_matching.json"));
    } catch (IOException e) {
  ...
  public void nonExistingOperationSameFieldName() {
    JsonNode statefulValue =
        getParameterValue(dict, "GET", "/non/existing", "items.snippet.thumbnails.default.height");
  ...
  public void sameOperationSameParameterName() {
    ...
    assertTrue(
        Arrays.asList("IT", "US", "JP", "DE", "FR", "FI", "NO", "ES")
  ...
  public void sameOperationSameFieldName() {
    JsonNode statefulValue =
        getParameterValue(
            dict, "GET", "/youtube/v3/search", "items.snippet.thumbnails.default.height");
    assertEquals("90", statefulValue.asText());
  }
  ...
  public void differentOperationSameParameterName() {
    JsonNode statefulValue =
        getParameterValue(dict, "GET", "/youtube/v3/search", "dvndf:-()=knkj13kmlas/b$%·g");
  ...
  public void differentOperationSameFieldName() {
    JsonNode statefulValue =
        getParameterValue(dict, "GET", "/youtube/v3/search", "comments.snippet.tags.snippet.id");
  ...
  public void sameOperationDifferentParameterName2() {
    JsonNode statefulValue =
        getParameterValue(dict, "GET", "/youtube/v3/search", "thumbnailHighHeight");
  ...
  public void sameOperationDifferentFieldName2() {
    JsonNode statefulValue =
        getParameterValue(dict, "GET", "/youtube/v3/search", "thumbnail.high.height");
    assertEquals("360", statefulValue.asText());
  }
  ...
  public void sameOperationDifferentFieldNameLonger2() {
    JsonNode statefulValue =
        getParameterValue(dict, "GET", "/youtube/v3/search", "search.pages.nextPageToken");
    assertTrue(
        Arrays.asList("CAUQAA", "CAQQAA", "CBYQAA", "CDAQAA").contains(statefulValue.asText()));
  }
  ...
  public void differentOperationDifferentParameterName() {
    JsonNode statefulValue =
        getParameterValue(dict, "GET", "/youtube/v3/search", "advndf:-()=knkj13kmlas/b$%·g");
    assertEquals("7", statefulValue.asText());
  }
  ...
  public void differentOperationDifferentFieldNameLongerMultipleMatches() {
    JsonNode statefulValue =
        getParameterValue(dict, "GET", "/youtube/v3/search", "authors.comments.id");
    assertTrue(Arrays.asList("8", "9", "10").contains(statefulValue.asText()));
  }
  ...
  public void paramNameNotFound2() {
    JsonNode statefulValue =
        getParameterValue(dict, "GET", "/youtube/v3/search", "dvndf:-()=knkj13kmlas/b$%·ga");
    assertNull(statefulValue);
  }
  ...
  public void paramNameNotFound3() {
    JsonNode statefulValue =
        getParameterValue(
            dict, "GET", "/youtube/v3/search", "items.snippet.thumbnails.medium.height.1");
    assertNull(statefulValue);
  }
  ...
  public void paramNameIdSearchIdNonExisting() {
    ...
    assertTrue(
        Arrays.asList(
                "PLhHUqrvxXXCZs5fkLYW_zguo5BeVdz9XQ",
                "PLatn_iwPkj2pT4HucLlKJDOqoc1xQDgWK",
                "UCyEGR4ZUT5tR9L0ite00tDQ",
  ...
  public void paramNameFirstLevelSubPropertyOfExistingProperty() {
    JsonNode statefulValue =
        getParameterValue(
            ...
            "GET",
            "/youtube/v3/search",
            "nonExistingProperty.snippet.thumbnails.medium.height");
  ...
  public void paramNameLastLevelSubPropertyOfExistingProperty() {
    JsonNode statefulValue =
        getParameterValue(
            ...
            "GET",
            "/youtube/v3/comments",
            "made.up.1.items.snippet.made.up.2.liveBroadcastContent");
  ...
  public void paramNameSubPropertyOfNonExistingProperty() {
    JsonNode statefulValue =
        getParameterValue(
            ...
            "GET",
            "/youtube/v3/comments",
            "made.up.1.items.snippet.made.up.2.liveBroadcastContent.madeUpProperty");
    assertNull(statefulValue);
  }
}

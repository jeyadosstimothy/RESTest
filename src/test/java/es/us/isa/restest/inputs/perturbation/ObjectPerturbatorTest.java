...
public class ObjectPerturbatorTest {
  ...
  public void testConstructorWithoutArguments() {
    ObjectPerturbator objectPerturbator =
        (ObjectPerturbator) TestDataGeneratorFactory.createTestDataGenerator(generator);
  ...
  public void testConstructorWithArgumentJsonNode() {
    ...
    assertNotNull(
        "The originalObjects list should not be null", objectPerturbator.getOriginalObjects());
    assertEquals(
        "The original object should be '{}'",
        "{}",
        objectPerturbator.getOriginalStringObjects().get(0));
  }
  ...
  public void testConstructorWithMultipleArguments() {
    ...
    for (String object : objectPerturbator.getOriginalStringObjects()) {
      boolean b =
          object.equals("{}")
              || object.equals("[]")
              || object.equals("{\"prop1\":\"val1\",\"prop2\":[1,true,{}]}");
      assertTrue(
          "The original objects should be '{}', '[]' and '{\"prop1\": \"val1\", \"prop2\": [1,"
              + " true, {}]}'",
          b);
    }
  }
  ...
  public void testConstructorWithArgumentFile() throws IOException {
    ...
    assertNotNull(
        "The originalObjects list should not be null", objectPerturbator.getOriginalObjects());
    assertEquals(
        "The original object should be '" + jsonObject.toString() + "'",
        jsonObject.toString(),
        objectPerturbator.getOriginalStringObjects().get(0));
  }
  ...
  public void testNextValueAsString() {
    ...
    assertNotEquals(
        objectPerturbator.getOriginalStringObjects().get(0), objectPerturbator.nextValueAsString());
    assertNotEquals(
        objectPerturbator.getOriginalStringObjects().get(0), objectPerturbator.nextValueAsString());
    assertNotEquals(
        objectPerturbator.getOriginalStringObjects().get(0), objectPerturbator.nextValueAsString());

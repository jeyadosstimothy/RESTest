...
public class FuzzingDictionaryTest {
    ...
    try {
      fuzzingDict =
          objectMapper.readValue(
              new File("src/main/resources/fuzzing-dictionary.json"),
  ...
  public void stringValuesTest() {
    ...
    assertTrue(
        getFuzzingStringValues()
            .containsAll(Arrays.asList("null", "", "\\0", "randomString", "one space")));
  }
  ...
  public void invalidTypeDefaultsToStringValuesSingleValueTest() {
    assertTrue(
        Arrays.asList("null", "", "\\0", "randomString", "one space")
            .contains(getFuzzingValue("invalidType")));
  }
  ...
  public void getNodeFuzzingValueNumberTest() {
    ...
    assertTrue(
        node instanceof TextNode
            ...
            || node instanceof DecimalNode
            || node instanceof BigIntegerNode);
  }

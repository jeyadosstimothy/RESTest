...
public class RandomObjectGeneratorTest {
  ...
  public void testConstructorWithoutArguments() {
    RandomObjectGenerator objGen =
        (RandomObjectGenerator) TestDataGeneratorFactory.createTestDataGenerator(generator);
    objGen.setSeed(99999);

    assertEquals(
        "The RandomObjectGenerator has not been initialized properly", 99999, objGen.getSeed());
  }
  ...
  public void testConstructorWithFileArguments() {
    ...
    files.setValues(
        Collections.singletonList(
            "src/test/resources/restest-test-resources/compare1.postman_collection.json"));
  ...
  public void testNextValue() {
    ...
    assertTrue(
        "The next value should be of type HashMap",
        objGen.nextValue() instanceof java.util.HashMap);
  }
  ...
  public void testNextValueAsString() {
    ...
    assertEquals(
        "The next value is not the expected one",

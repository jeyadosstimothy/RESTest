...
public class RandomInputValueIteratorTest {
  ...
  public void testRandomStringIterator() {
    ...
    RandomInputValueIterator<String> iterator =
        (RandomInputValueIterator) TestDataGeneratorFactory.createTestDataGenerator(generator);
  ...
  public void testRandomStringIteratorWithCSVFile() {
    ...
    values.setName("csv");
    values.setValues(
        Collections.singletonList("src/main/resources/TestData/BingSupportedLanguages.csv"));

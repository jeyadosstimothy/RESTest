...
public class RandomRegExpGeneratorTest {
  ...
  public void testRandomRegExpGeneration() {
    ...
    RandomRegExpGenerator gen =
        (RandomRegExpGenerator) TestDataGeneratorFactory.createTestDataGenerator(generator);
  ...
  public void testRandomBoundedRegExpGeneration() {
    ...
    for (int i = 0; i < 100; i++) {
      ...
      assertTrue("The string does not match the regular expression", value.matches(regExp));
      assertTrue(
          "The string does not match the requested length",
  ...
  public void testSeed() {
    ...
    for (int i = 0; i < 100; i++) values1.add(gen.nextValue());

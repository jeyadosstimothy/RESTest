...
public class RandomStringGeneratorTest {
  ...
  public void testDefaultConstructor() {
    RandomStringGenerator strGen =
        (RandomStringGenerator) TestDataGeneratorFactory.createTestDataGenerator(generator);
    ...
    assertTrue(
        "includeAlphabetic parameter should be true by default", strGen.getIncludeAlphabetic());
    assertFalse("includeNumbers parameter should be false by default", strGen.getIncludeNumbers());
    assertFalse(
        "includeSpecialCharacters parameter should be false by default",
        strGen.getIncludeSpecialCharacters());
  }
  ...
  public void testSetters() {
    ...
    assertTrue(
        "includeSpecialCharacters parameter should be true", strGen.getIncludeSpecialCharacters());
  }
  ...
  public void testEmptyString() {
    ...
    generator
        ...
        .addAll(
            Arrays.asList(
                minLength, maxLength, includeSpecialCharacters, includeNumbers, includeAlphabetic));
  ...
  public void testStringWithoutNumbers() {
    ...
    System.out.println(testString);
    assertFalse(
        "The generated string should not contain any number", testString.matches(".*[0-9].*"));
  }
  ...
  public void testStringWithoutAlphabet() {
    ...
    System.out.println(testString);
    assertFalse(
        "The generated string should not contain any alphabetic character",
        testString.matches(".*[A-Za-z].*"));
  }
  ...
  public void testStringWithoutNumbersOrAlphabet() {
    ...
    System.out.println(testString);
    assertFalse(
        "The generated string should not contain any alphanumeric character",
        testString.matches(".*[0-9A-Za-z].*"));
  }
}

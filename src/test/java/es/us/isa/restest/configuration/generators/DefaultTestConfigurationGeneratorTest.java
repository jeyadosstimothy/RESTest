...
public class DefaultTestConfigurationGeneratorTest {
  ...
  public void testSpotifyTestConfigurationGeneration() {
    ...
    //		albumFilter.addGetMethod();              //It is a GET operation, so we only add the GET
    ...
    //		artistFilter.addGetMethod();                                  //It is a GET operation, so we
    // only add the GET method to the operation
    //

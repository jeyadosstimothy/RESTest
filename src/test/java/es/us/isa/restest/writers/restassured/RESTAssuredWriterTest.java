...
public class RESTAssuredWriterTest {
  ...
  public void test() {
    ...
    TestCase tc =
        new TestCase(
            "findPetsByStatusId", false, "findPetsByStatus", "/pet/findByStatus", HttpMethod.GET);
  ...
  public void statefulFilterEnabledTest() {
    ...
    assertTrue(
        ...
        readFile("src/generation/java/restassured/CommentsTestStateful.java")
            .contains("statefulFilter.setOperation"));
  }
  ...
  public void statefulFilterDisabledTest() {
    ...
    assertFalse(
        ...
        readFile("src/generation/java/restassured/CommentsTestNonStateful.java")
            .contains("statefulFilter.setOperationId"));
  }
}

...
public class PostmanWriterTest {
  ...
  public void generateTestCasesAndExportTest() throws RESTestException {
    ...
    TestConfigurationObject conf =
        TestConfigurationIO.loadConfiguration("src/test/resources/Travel/testConf.yaml", spec);
    ...
    PostmanWriter postmanWriter =
        new PostmanWriter(spec.getSpecification().getServers().get(0).getUrl());
  ...
  public void generateTestCasesWithUrlencodedAndExportTest() throws RESTestException {
    ...
    TestConfigurationObject conf =
        TestConfigurationIO.loadConfiguration(
            "src/test/resources/Stripe/testConf_forTestSuite.yaml", spec);
  ...
  public void compareGeneratedTestSuitesTest() throws IOException {
    ...
    PostmanCollectionObject originalTestSuite =
    ...
    TestCase tc2 =
        new TestCase("test2", true, "op2", "/example2/{example_N}", PathItem.HttpMethod.POST);
    ...
    PostmanCollectionObject generatedTestSuite =
        objectMapper.readValue(
    ...
    assertEquals(
        "The generated test suite should be equal to the original one",
        originalTestSuite,
        generatedTestSuite);
  }
}

...
public class RESTestExecutorTest {
  ...
  public void testExecutor() throws RESTestException {
    ...
    RESTestLoader loader =
        new RESTestLoader("src/test/resources/Restcountries/restcountries_demo.properties");
    ...
    RESTestExecutor executor =
        new RESTestExecutor("src/test/resources/Restcountries/restcountries_demo.properties");
    executor.execute();

...
public class RESTestRunnerTest {
  ...
  public void testRunner() throws RESTestException {
    ...
    OpenAPISpecification spec =
        new OpenAPISpecification("src/test/resources/YouTube/swagger_betty.yaml");
    ...
    RESTAssuredWriter writer =
        new RESTAssuredWriter(
            "src/test/resources/YouTube/swagger_betty.yaml",
            "src/test/resources/YouTube/testConf_betty.yaml",
            "src/generation/java/runnerTest",
            "RunnerTest",
            "runnerTest",
            basePath,
            false);
    ...
    AllureReportManager arm =
        new AllureReportManager(allureResultsDir, allureReportDir, new ArrayList<>());

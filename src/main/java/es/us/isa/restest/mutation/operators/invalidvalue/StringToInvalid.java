...
/**
 * Mutate a string parameter by assigning it a string, a boolean, or violating either a max or min
 * constraint.
 *
...
public class StringToInvalid extends AbstractToInvalidOperator {
  ...
  private static final String[] mutations = {
    VIOLATE_FORMAT_CONSTRAINT, VIOLATE_MAX_LENGTH_CONSTRAINT, VIOLATE_MIN_LENGTH_CONSTRAINT
  };

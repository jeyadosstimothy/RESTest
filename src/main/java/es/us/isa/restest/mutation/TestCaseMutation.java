...
public class TestCaseMutation {
  ...
  /**
   * Given a valid (nominal) test case, if possible, mutate it and convert it into an invalid
   * (faulty) test case. Set of possible mutations:
   *
   * <ol>
   *   <li>Remove required parameter.
   *   <li>Change type of parameter value (e.g. use a string for an integer parameter).
   *   <li>Violate a constraint of a parameter (e.g. use an integer value higher than the maximum.
   * </ol>
   *
   * @param testCase Original valid test case. NOTE: If the mutation is applied, the original {@code
   *     nominalTestCase} object will not be preserved, it should be cloned before calling this
   *     method.

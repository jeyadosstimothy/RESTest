...
/**
 * Mutate a number parameter by assigning it a string, a boolean, or violating either a max or min
 * constraint.
 *
...
public class NumberToInvalid extends AbstractToInvalidOperator {
  ...
  private static final String[] mutations = {
    VIOLATE_MAX_CONSTRAINT, VIOLATE_MIN_CONSTRAINT, REPLACE_WITH_STRING, REPLACE_WITH_BOOL
  };

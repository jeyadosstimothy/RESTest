...
/**
 * Mutate an enum parameter by assigning it an out-of-range value, either a string, boolean or
 * integer.
 *
...
public class EnumToInvalid extends AbstractToInvalidOperator {
  ...
  private static final String[] mutations = {
    REPLACE_WITH_INT, REPLACE_WITH_NUMBER, REPLACE_WITH_STRING, REPLACE_WITH_BOOL
  };

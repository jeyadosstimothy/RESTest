...
public enum DataType {
  ...
  public boolean isNumber() {
    ...
    if (this.equals(DataType.INTEGER)
        || this.equals(DataType.FLOAT)
        || this.equals(DataType.LONG)
        || this.equals(DataType.DOUBLE)
        || this.equals(DataType.INT32)
        || this.equals(DataType.INT64)
        || this.equals(DataType.NUMBER)) isNumber = true;
    return isNumber;
  }
}

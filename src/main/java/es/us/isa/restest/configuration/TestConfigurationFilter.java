 ...
 * the API specification. This class allow to define filters to describe the specific operations or
 * paths to be tested. A filter is composed of a path and a set of HTTP methods (GET, POST...).
 * (GET, POST...)
 */

...
public class Auth {
  ...
  private String apiKeysPath; // JSON file containing array of API keys (path relative to
  // src/test/resources/auth/)
  private String headersPath; // JSON file containing array of auth headers (path relative to
  // src/test/resources/auth/)
  private String
      oauthPath; // JSON file containing OAuth details (path relative to src/test/resources/auth/)

...
public class TestDataGeneratorFactory {
    ...
    switch (generator.getType()) {
      ...
      default:
        throw new IllegalArgumentException(
            "Unexpected parameter for generator TestDataGenerator factory: " + generator.getType());
    }
  ...
  private static ITestDataGenerator createRandomDate(Generator generator) {
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for random date generator: " + param.getName());
      }
    }
  ...
  private static ITestDataGenerator createRandomEnglishWordGenerator(Generator generator) {
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for random English word generator: " + param.getName());
      }
    }
  ...
  private static ITestDataGenerator createRandomInputValueGenerator(Generator generator) {
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for generator RandomInputValue: " + param.getName());
      }
    }
  ...
  private static ITestDataGenerator createInputValueIterator(Generator generator) {
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for InputValueIterator: " + param.getName());
      }
    }
  ...
  private static ITestDataGenerator createRandomNumber(Generator generator) {
    ...
    GenParameter typeParam =
        TestConfigurationVisitor.searchGenParameter("type", generator.getGenParameters());
    ...
    switch (typeParam.getValues().get(0)) {
      ...
      default:
        throw new IllegalArgumentException(
            "Wrong number type value" + typeParam.getValues().get(0));
    }
  ...
  private static RandomNumberGenerator createRandomFloatGenerator(
      DataType type, Generator generator) {
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for random float generator: " + param.getName());
      }
    }
  ...
  private static RandomNumberGenerator createRandomLongGenerator(
      DataType type, Generator generator) {
    RandomNumberGenerator gen = new RandomNumberGenerator(type);
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for random long generator: " + param.getName());
      }
    }
  ...
  private static RandomNumberGenerator createRandomDoubleGenerator(
      DataType doubleType, Generator generator) {
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for random double generator: " + param.getName());
      }
    }
  ...
  private static RandomNumberGenerator createRandomIntegerGenerator(
      DataType intType, Generator generator) {
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for random integer generator: " + param.getName());
      }
    }
  ...
  private static RandomRegExpGenerator createRandomRegExpGenerator(Generator generator) {
    ...
    GenParameter regExpParam =
        TestConfigurationVisitor.searchGenParameter("regExp", generator.getGenParameters());
    ...
    else gen = new RandomRegExpGenerator(regExpParam.getValues().get(0));
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for random regExp generator: " + param.getName());
      }
    }
  ...
  private static RandomBooleanGenerator createRandomBooleanGenerator(Generator generator) {
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for random boolean generator: " + param.getName());
      }
    }
  ...
  private static RandomObjectGenerator createRandomObjectGenerator(Generator generator) {
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for object generator: " + param.getName());
      }
    }
    return gen;
  }
  ...
  private static ObjectPerturbator createObjectPerturbator(Generator generator) {
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for object perturbator: " + param.getName());
      }
    }
  ...
  private static RandomStringGenerator createRandomStringGenerator(Generator generator) {
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for random string generator: " + param.getName());
      }
    }
  ...
  private static ITestDataGenerator createBoundaryStringGenerator(Generator generator) {
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for boundary string generator: " + param.getName());
      }
    }

    // Create random generator or iterator, depending on the type
    // Once we have configured the boundary strings to be generated, add them to the set of values
    // of the generator
    if (generator.getType().equals("RandomBoundaryString"))
      gen = new RandomInputValueIterator<>(boundStrConf.returnValues());
    else gen = new InputValueIterator<>(boundStrConf.returnValues());
  ...
  private static ITestDataGenerator createBoundaryNumberGenerator(Generator generator) {
    ...
    if (!typeParam.getValues().get(0).equals("integer")
      ...
      throw new IllegalArgumentException(
          "'" + typeParam.getValues().get(0) + "' is not a valid number type");
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for boundary number generator: " + param.getName());
      }
    }

    // Create random generator or iterator, depending on the type
    // Once we have configured the boundary numbers to be generated, add them to the set of values
    // of the generator
    if (generator.getType().equals("RandomBoundaryNumber"))
      gen = new RandomInputValueIterator<>(boundNumbConf.returnValues());
    else gen = new InputValueIterator<>(boundNumbConf.returnValues());
  ...
  private static ITestDataGenerator createBodyGenerator(Generator generator) {
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for stateful body generator: " + param.getName());
      }
    }
    return gen;
  }
  ...
  private static ITestDataGenerator createParameterGenerator(Generator generator) {
    ...
    for (GenParameter param : generator.getGenParameters()) {
      switch (param.getName()) {
        ...
        default:
          throw new IllegalArgumentException(
              "Unexpected parameter for stateful parameter generator: " + param.getName());
      }
    }
    return gen;
  }

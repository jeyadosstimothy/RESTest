...
public class RESTestCLI {
  ...
  private static final String BASE_COPY_PROPERTY_FILE_PATH =
      "src/main/resources/base-copy.properties";
    ...
    try {
      ...
      if (cmd.hasOption("c")) {
        ...
        if (!isOASFile) {
          throw new RuntimeException(
              "Error: The provided file is not a valid OpenAPI specification.");
        }
      ...
      if (cmd.hasOption("o")) {
        ...
        if (propFileOptionG == null && propFileOptionE == null) {
          throw new RuntimeException(
              "Error parsing command line arguments: Missing argument for option: g or e");
        ...
        if (propFile == null) {
          throw new RuntimeException(
              "Error parsing command line arguments: Missing argument for option: e");
        }
        ...
        if (propFile == null) {
          throw new RuntimeException(
              "Error parsing command line arguments: Missing argument for option: g");
        }

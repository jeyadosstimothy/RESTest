...
/**
 * This class load the properties files and generate the main objects for test case generation,
 * execution and reporting.
 */
public class RESTestLoader {

  static String
      userPropertiesFilePath; // Path to user properties file (if any). If not provided, default
  // values will be used from global property file (config.properties).
  ...
  public void readProperties() {
    ...
    if (readProperty("delay") != null) timeDelay = Integer.parseInt(readProperty("delay"));
  ...
  // Read the parameter values from the user property file (if provided). If the value is not found,
  // look for it in the global .properties file (config.properties)
  ...
  private void setUpLogger() {
    ...
    String logPath =
        readProperty("data.log.dir")
            + "/"
            + readProperty("experiment.name")
            + "/"
            + readProperty("data.log.file");

...
/**
 * This example shows how to generate a set of test cases using the Constraint-Based test case
 * generator and write them to a file using the RESTAssured writer. Test cases are generated by
 * randomly selecting values for each input parameter making sure that inter-parameter dependencies
 * are satisfied (or violated on purpose). This is possible thanks to the use of a constraint solver
 * (Choco) and IDL, a domain-specific language for specifying inter-parameter dependencies as a part
 * of the OAS specification. See the following post for more details:
 * https://medium.com/isa-group/handling-inter-parameter-dependencies-in-rest-apis-with-idl4oas-e5489abac32f
 * See test cases for more examples.
 *
 * <p>The resources for this example are located at src/main/resources/Examples/Ex3_CBTGeneration.
 */
public class Ex3_CBTGeneration {

  public static final String PROPERTY_FILE_PATH =
      "src/main/resources/Examples/Ex3_CBTGeneration/user_config.properties"; // Path to user
  // properties file
  // with configuration
  // options

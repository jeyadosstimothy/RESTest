...
/**
 * This example shows how to generate a set of test cases using SemanticGenerator and write them to
 * a file using the RESTAssured writer. These types of tests are based on modifying a generated test
 * so that it is entirely different from the previous one.
 *
 * <p>The resources for this example are located at
 * src/main/resources/Examples/Ex4_ARTestGeneration.
 *
 * <p>*
 */
public class Ex4_ARTestGeneration {
  ...
  public static final String PROPERTY_FILE_PATH =
      "src/main/resources/Examples/Ex4_ARTestGeneration/omdb.properties"; // Path to user properties
